...
<div id="content" class="relative flex min-h-screen items-center justify-center overflow-hidden bg-gradient-to-br from-blue-50 via-pink-50 to-yellow-50 backdrop-blur-3xl">
    ...
    {#if !showPassword}
        <div class="question-card relative w-full max-w-md rounded-[2rem] bg-white/60 p-10 shadow-xl backdrop-blur-lg">
            ...
            <h1 class="mb-8 text-center text-3xl font-bold text-pink-600">Will you be my Valentine?</h1>
